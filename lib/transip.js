...
module.exports = function (privateKey, timeout) {
  ...
  return {
    ...
    account: {
      invoices: {
        ...
        list: function (token, callback) {
          httpRequest(
            { method: "GET", path: "/v6/invoices", token: token },
            callback
          );
        },
      ...
      sshkeys: {
        ...
        list: function (token, callback) {
          httpRequest(
            { method: "GET", path: "/v6/ssh-keys", token: token },
            callback
          );
        },
        ...
        retrieve: function (id, token, callback) {
          httpRequest(
            { method: "GET", path: "/v6/ssh-keys/" + id, token: token },
            callback
          );
        },
        ...
        remove: function (id, token, callback) {
          ...
          httpRequest(
            { method: "DELETE", path: "/v6/ssh-keys/" + id, token: token },
            callback
          );
        },
      },
    ...
    general: {
      api: {
        ...
        test: function (token, callback) {
          httpRequest(
            { method: "GET", path: "/v6/api-test", token: token },
            callback
          );
        },
      },
      ...
      products: {
        ...
        list: function (token, callback) {
          httpRequest(
            { method: "GET", path: "/v6/products", token: token },
            callback
          );
        },
      ...
      availabilityzones: {
        ...
        list: function (token, callback) {
          httpRequest(
            { method: "GET", path: "/v6/availability-zones", token: token },
            callback
          );
        },
      },
    ...
    domains: {
      ...
      list: function (token, callback) {
        httpRequest(
          { method: "GET", path: "/v6/domains", token: token },
          callback
        );
      },
      ...
      retrieve: function (domainName, token, callback) {
        httpRequest(
          { method: "GET", path: "/v6/domains/" + domainName, token: token },
          callback
        );
      },
      ...
      register: function (params, token, callback) {
        httpRequest(
          { method: "POST", path: "/v6/domains", params: params, token: token },
          callback
        );
      },
    ...
    whitelabel: {
      ...
      order: function (token, callback) {
        httpRequest(
          { method: "POST", path: "/v6/whitelabel", token: token },
          callback
        );
      },
    },
    ...
    tlds: {
      ...
      list: function (token, callback) {
        httpRequest(
          { method: "GET", path: "/v6/tlds", token: token },
          callback
        );
      },
      ...
      get: function (tld, token, callback) {
        httpRequest(
          { method: "GET", path: "/v6/tlds/" + tld, token: token },
          callback
        );
      },
    },
    ...
    vps: {
      ...
      get: function (vpsName, token, callback) {
        httpRequest(
          { method: "GET", path: "/v6/vps/" + vpsName, token: token },
          callback
        );
      },
      ...
      order: function (params, token, callback) {
        httpRequest(
          { method: "POST", path: "/v6/vps", params: params, token: token },
          callback
        );
      },
    ...
    traffic: {
      ...
      get: function (token, callback) {
        httpRequest(
          { method: "GET", path: "/v6/traffic", token: token },
          callback
        );
      },
      ...
      vps: {
        ...
        get: function (vpsName, token, callback) {
          httpRequest(
            { method: "GET", path: "/v6/traffic/" + vpsName, token: token },
            callback
          );
        },
      },
    ...
    mailservice: {
      ...
      get: function (token, callback) {
        httpRequest(
          { method: "GET", path: "/v6/mail-service", token: token },
          callback
        );
      },
      ...
      regenerate: function (token, callback) {
        httpRequest(
          { method: "PATCH", path: "/v6/mail-service", token: token },
          callback
        );
      },
    ...
    monitoringcontacts: {
      ...
      list: function (token, callback) {
        httpRequest(
          { method: "GET", path: "/v6/monitoring-contacts", token: token },
          callback
        );
      },
    ...
    haips: {
      ...
      list: function (token, callback) {
        httpRequest(
          { method: "GET", path: "/v6/haips", token: token },
          callback
        );
      },
      ...
      get: function (haipName, token, callback) {
        httpRequest(
          { method: "GET", path: "/v6/haips/" + haipName, token: token },
          callback
        );
      },
      ...
      order: function (params, token, callback) {
        httpRequest(
          { method: "POST", path: "/v6/haips", params: params, token: token },
          callback
        );
      },
    ...
    colocations: {
      ...
      list: function (token, callback) {
        httpRequest(
          { method: "GET", path: "/v6/colocations", token: token },
          callback
        );
      },
    ...
    openstack: {
      projects: {
        ...
        list: function () {
          httpRequest(
            { method: "GET", path: "/v6/openstack/projects", token: token },
            callback
          );
        },
      },
